...
app = Flask(__name__)
CORS(app)  # allow cross-origin requests from the collector
...
if os.path.exists(MODEL_FILE):
    ...
    print("Model not found. Train model with train_model.py or train_baseline.py")

# simple root status page
...
if __name__ == '__main__':
    # Use a safe port (8000). Change here if you prefer another.
    print("Starting inference server on 0.0.0.0:8000 ...")
